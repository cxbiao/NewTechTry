...
//		});
		...
		mRecyclerView.setOnScrollListener(new OnScrollListener() {
			...
			public void onScrollStateChanged(RecyclerView recyclerView,
				...
				//Log.e(TAG,"recyclerviewHight:"+recyclerView.getHeight());   //1屏的高度
		...
		if(mAdapter==null || mAdapter.getItemCount()==0){
			...
			if(lastVisiblePosition==totalItemCount-1){
				...
				if (lastVisibleChild != null) {
					Log.e(TAG, "lastVisibleChild.getBottom():"+lastVisibleChild.getBottom()+",mRecyclerView.getTop():"+mRecyclerView.getTop()+",mRecyclerView.getBottom():"+mRecyclerView.getBottom());
